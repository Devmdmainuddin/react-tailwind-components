                        ...
                        <div
                            ...
                            <div className="flex items-center gap-8">
                                <button id="slider-button-left"
                                    ...
                                    data-carousel-prev>
                                    <i
                                        className="fa-solid fa-arrow-left text-indigo-600 group-hover:text-white transition-all duration-300"></i>
                                ...
                                <button id="slider-button-right"
                                    ...
                                    data-carousel-next>
                                    <i className="fa-solid fa-arrow-right-long text-indigo-600 group-hover:text-white transition-all duration-300"></i>
                                </button>
                            </div>
                        </div>

                        <div className="lg:flex grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-8 swiper mySwiper_01">
                            <div className="swiper-wrapper">
                                <div
                                    ...
                                    <div
                                        ...
                                        <i className="fa-solid fa-star"></i>
                                        <i className="fa-solid fa-star"></i>
                                        <i className="fa-solid fa-star text-[#CED5D8]"></i>
                                    </div>
                                    <p
                                        className="text-lg text-gray-500 leading-8 h-24 transition-all duration-500 mb-9 group-hover:text-gray-800">
                                        Pagedone is simply the best tool of investment in the market right now. </p>
