...
const Team1 = () => {
    return (
        <div className="w-[425px] relative mt-16 mb-32 sm:mb-24 ">
            <div className="rounded overflow-hidden shadow-md bg-white">
                <div className="absolute -mt-20 w-full flex justify-center">
                    <div className="h-32 w-32">
                        <img src="https://cdn.tuk.dev/assets/photo-1530577197743-7adf14294584.jfif" alt='image' className="rounded-full object-cover h-full w-full shadow-md" />
                    </div>
                </div>
