...
const Card1 = () => {
    return (
        <div>
<img className="inline-flex object-cover border-4 border-indigo-600 rounded-full hover:shadow-[5px_5px_0_0_rgba(0,0,0,1)] hover:shadow-indigo-600/100 bg-indigo-50 text-indigo-600 h-24 w-24 !h-48 !w-48 transition-all duration-500" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwyfHxoZWFkc2hvdHxlbnwwfDB8fHwxNjk1ODE3MjEzfDA&ixlib=rb-4.0.3&q=80&w=1080" alt=""/>
