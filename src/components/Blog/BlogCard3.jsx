...
const BlogCard3 = () => {
    return (
        <div>
            <section className="w-[400px] p-5 py-10 bg-purple-50 text-center transform duration-500 hover:-translate-y-2 cursor-pointer">
                <img src="https://www.dropbox.com/s/mlor33hzk73rh0c/x14423.png?dl=1" alt="" className=" h-[400px]" />
