        ...
        <div className='bg-blue-100 bg-opacity-30'>
            <Container>
                ...
                <nav className=" flex justify-between ">
                    <div className="py-3 flex justify-start gap-16 w-full items-center">
                        <Link className="flex-shrink-0 text-3xl font-bold font-heading" href="#">
                            <img className="h-9 w-10" src="https://i.ibb.co/QM0knDP/Mask-Group.jpg" alt="" />
                        </Link>
                        <ul
                            className="hidden lg:flex transform  lg:items-center gap-6 lg:w-auto">
                            <li><NavLink className="font-bold font-heading hover:text-gray-600" >Category</NavLink></li>
                            <li><NavLink className=" font-bold font-heading hover:text-gray-600" >Collection</NavLink></li>
                            <li><NavLink className=" font-bold font-heading hover:text-gray-600" >Story</NavLink></li>
                            <li><NavLink className=" font-bold font-heading hover:text-gray-600" >Brand</NavLink></li>
                            <li><NavLink className="font-bold font-heading hover:text-gray-600" >Photos</NavLink></li>
                        </ul>
                    </div>
                    <div className="flex items-center gap-6 justify-end">
                        ...
                        <Link className="flex items-center relative" href="#">
                            <svg className="" width="23" height="23" viewBox="0 0 23 23" fill="none"
                            ...
                            <span className="inline-block absolute -top-3 -right-4 w-6 h-6 text-center bg-orange-300 rounded-full font-semibold font-heading text-white">3</span>
                        </Link>
                        <Link className="w-full flex items-center px-6 border-l font-semibold font-heading" href="#">
                            <svg className="" width="32" height="31" viewBox="0 0 32 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <Link className="navbar-burger self-center  xl:hidden" href="#">
